...
local suggestion = {auto_trigger = true, hide_during_completion = true, debounce = 150, keymap = {accept = "<C-a>", next = "<M-]>", prev = "<M-[>", dismiss = "<M-e>", accept_line = false, accept_word = false}}
