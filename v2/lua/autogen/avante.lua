...
local windows = {position = "right", fillchars = "eob: ", wrap = true, width = 50, height = 50, sidebar_header = {align = "center", enabled = false, rounded = false}, input = {prefix = "\239\146\181 ", height = 8}, edit = {border = "single", start_insert = true}, ask = {border = "single", start_insert = true, focus_on_apply = "ours", floating = false}}
