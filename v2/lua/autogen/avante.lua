...
local windows = {position = "left", fillchars = "eob: ", wrap = true, width = 30, height = 50, sidebar_header = {align = "center", enabled = false, rounded = false}, spinner = {editing = {"\226\161\128", "\226\160\132", "\226\160\130", "\226\160\129", "\226\160\136", "\226\160\144", "\226\160\160", "\226\162\128", "\226\163\128", "\226\162\132", "\226\162\130", "\226\162\129", "\226\162\136", "\226\162\144", "\226\162\160", "\226\163\160", "\226\162\164", "\226\162\162", "\226\162\161", "\226\162\168", "\226\162\176", "\226\163\176", "\226\162\180", "\226\162\178", "\226\162\177", "\226\162\184", "\226\163\184", "\226\162\188", "\226\162\186", "\226\162\185", "\226\163\185", "\226\162\189", "\226\162\187", "\226\163\187", "\226\162\191", "\226\163\191"}, generating = {"\226\156\182", "\226\156\184", "\226\156\185", "\226\156\186", "\226\156\185", "\226\156\183"}, thinking = {"\226\150\129", "\226\150\130", "\226\150\131", "\226\150\132", "\226\150\133", "\226\150\134", "\226\150\135", "\226\150\136"}}, input = {prefix = "\239\146\181 ", height = 8}, edit = {border = "single", start_insert = true}, ask = {floating = true, border = "single", start_insert = true, focus_on_apply = "ours"}}
...
custom_tools = _4_
local acp_providers = {["claude-code"] = {command = "claude-agent-acp", args = {}, env = {NODE_NO_WARNINGS = "1", CLAUDE_CODE_OAUTH_TOKEN = os.getenv("CLAUDE_CODE_OAUTH_TOKEN")}}}
