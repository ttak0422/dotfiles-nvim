...
local behaviour = {auto_suggestions = true, auto_set_highlight_group = true, auto_set_keymaps = true, support_paste_from_clipboard = true, minimize_diff = true, enable_token_counting = true, auto_approve_tool_permissions = true, auto_check_diagnostics = true, confirmation_ui_style = "inline_buttons", acp_follow_agent_locations = true, auto_add_current_file = false, auto_apply_diff_after_generation = false, auto_focus_on_diff_view = false, auto_focus_sidebar = false, auto_suggestions_respect_ignore = false, enable_fastapply = false, include_generated_by_commit_line = false, jump_result_buffer_on_finish = false, use_cwd_as_project_root = false}
local mappings
do
