...
avante_lib.load()
return avante.setup({mode = "agentic", provider = "copilot", tokenizer = "tiktoken", behaviour = behaviour, history = history, highlights = highlights, img_paste = img_paste, mappings = mappings, windows = windows, diff = diff, hints = hints, repo_map = repo_map})
