...
local default = {dir_path = "assets", extension = "png", file_name = "%Y%m%d%H%M%S", template = "$FILE_PATH", relative_template_path = true, use_cursor_in_template = true, insert_mode_after_paste = true, prompt_for_file_name = true, max_base64_size = 10, process_cmd = "", download_images = true, drag_and_drop = {enabled = true, insert_mode = false}, copy_images = false, embed_image_as_base64 = false, relative_to_current_file = false, show_dir_path_in_prompt = false, url_encode_path = false, use_absolute_path = false}
