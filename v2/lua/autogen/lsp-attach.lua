...
local function _1_(ctx)
  if not vim.b.lsp_attached then
    ...
    for _, k in ipairs({{"gd", vim.lsp.buf.definition, "go to definition"}, {"gi", vim.lsp.buf.implementation, "go to implementation"}, {"gr", vim.lsp.buf.references, "go to references"}, {"<Leader>K", vim.lsp.buf.signature_help, "show signature"}, {"<Leader>D", vim.lsp.buf.type_definition, "show type"}, {"<Leader>ca", _3_, "code action"}, {"K", _4_, "show doc"}, {"gpd", "<Cmd>lua require('goto-preview').goto_preview_definition()<CR>", "preview definition"}, {"gpi", "<Cmd>lua require('goto-preview').goto_preview_implementation()<CR>", "preview implementation"}, {"gpr", "<Cmd>lua require('goto-preview').goto_preview_references()<CR>", "preview references"}, {"gP", "<Cmd>lua require('goto-preview').close_all_win()<CR>", "close all preview"}, {"gD", "<Cmd>Glance definitions<CR>", "go to definition"}, {"gI", "<Cmd>Glance implementations<CR>", "go to impl"}, {"gR", "<Cmd>Glance references<CR>", "go to references"}, {"<leader>cc", "<Cmd>Neogen class<CR>", "class comment"}, {"<leader>cf", "<Cmd>Neogen func<CR>", "fn comment"}, {"<leader>rn", ":IncRename ", "rename"}}) do
    ...
    vim.keymap.set({"n", "v"}, "<C-CR>", _7_, desc("\238\171\132 format"))
