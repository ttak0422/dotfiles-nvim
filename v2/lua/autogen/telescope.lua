...
local defaults = {path_display = {"truncate"}, prompt_prefix = "\239\128\130 ", selection_caret = "\239\129\161 ", sorting_strategy = "ascending", layout_config = {horizontal = {prompt_position = "top", preview_width = 0.55}, width = 0.87, height = 0.8}, mappings = {i = {["<C-j>"] = {"<Plug>(skkeleton-enable)", type = "command"}, ["<Down>"] = actions.cycle_history_next, ["<Up>"] = actions.cycle_history_prev}, n = {["<Down>"] = actions.cycle_history_next, ["<Up>"] = actions.cycle_history_prev}}}
local extensions
local function _1_()
