...
rm.setup({preset = "obsidian", file_types = {"markdown"}, render_modes = true, anti_conceal = anti_conceal, win_options = win_options, heading = heading, code = code, checkbox = checkbox, bullet = bullet, link = link, completions = completions})
