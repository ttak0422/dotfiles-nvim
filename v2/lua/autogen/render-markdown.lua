...
local heading = {position = "inline", icons = {"\243\176\188\143 ", "\243\176\142\168 ", "\243\176\188\145 ", "\243\176\142\178 ", "\243\176\188\147 ", "\243\176\142\180 "}, backgrounds = {}, sign = false}
local code = {border = "thin", above = "", below = "", conceal_delimiters = false}
...
rm.setup({preset = "obsidian", file_types = {"markdown", "Avante"}, render_modes = true, anti_conceal = anti_conceal, win_options = win_options, heading = heading, code = code, checkbox = checkbox, bullet = bullet, link = link, completions = completions})
