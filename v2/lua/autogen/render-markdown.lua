...
rm.setup({preset = "obsidian", file_types = {"markdown", "Avante"}, render_modes = {"n", "c", "t"}, anti_conceal = anti_conceal, win_options = win_options, heading = heading, code = code, link = link, completions = completions})
