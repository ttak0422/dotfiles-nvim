...
do
  ...
  local function _14_()
    local function _15_(_2410)
      return vim.cmd(("Pterm " .. _2410))
    end
    return vim.ui.input({prompt = "Terminal: "}, _15_)
  end
  local function _16_()
