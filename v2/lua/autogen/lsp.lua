...
return vim.lsp.enable({"bashls", "cssls", "dartls", "denols", "dhall_lsp_server", "rubocop", "fennel_ls", "gopls", "html", "jsonls", "lua_ls", "marksman", "nil_ls", "pyright", "solargraph", "taplo", "terraformls", "typos_lsp", "vtsls", "yamlls"})
