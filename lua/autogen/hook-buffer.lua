...
N = {{"gpd", lcmd("require('goto-preview').goto_preview_definition()"), desc("preview definition")}, {"gpi", lcmd("require('goto-preview').goto_preview_implementation()"), desc("preview implementation")}, {"gpr", lcmd("require('goto-preview').goto_preview_references()"), desc("preview references")}, {"gP", lcmd("require('goto-preview').close_all_win()"), desc("close all preview")}, {"<F5>", lcmd("require('dap').continue()"), desc("continue")}, {"<F10>", lcmd("require('dap').step_over()"), desc("step over")}, {"<F11>", lcmd("require('dap').step_into()"), desc("step into")}, {"<F12>", lcmd("require('dap').step_out()"), desc("step out")}, {"<LocalLeader>db", lcmd("require('dap').toggle_breakpoint()"), desc("dap toggle breakpoint")}, {"<LocalLeader>dB", _4_, desc("dap set breakpoint with condition")}, {"<LocalLeader>dr", lcmd("require('dap').repl.toggle()"), desc("dap toggle repl")}, {"<LocalLeader>dl", lcmd("require('dap').run_last()"), desc("dap run last")}, {"<LocalLeader>dd", _5_, desc("dap toggle ui")}}
