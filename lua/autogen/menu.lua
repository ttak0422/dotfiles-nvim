...
default = {{name = "Copy all content", cmd = "%y+"}, {name = "\238\154\144 Edit local config", cmd = "ConfigLocalEdit"}, separator, {name = "\243\176\132\137 Timer", cmd = _1_}, {name = "\239\132\156 Show keys", cmd = _2_}, {name = "\239\133\128 Color Picker", cmd = _3_}}
local function _4_()
