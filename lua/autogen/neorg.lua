...
do
  ...
  local load = {["core.autocommands"] = {}, ["core.defaults"] = {config = defaults}, ["core.export"] = {}, ["core.export.markdown"] = {config = markdown}, ["core.dirman"] = {config = dirman}, ["core.highlights"] = {config = highlights}, ["core.integrations.treesitter"] = {}, ["core.keybinds"] = {config = keybinds}, ["core.storage"] = {}, ["core.summary"] = {}, ["core.ui"] = {}, ["core.journal"] = {config = journal}, ["core.esupports.metagen"] = {config = metagen}, ["core.concealer"] = {config = concealer}, ["core.tempus"] = {}, ["core.ui.calendar"] = {}, ["core.integrations.telescope"] = {}, ["external.jupyter"] = {}}
