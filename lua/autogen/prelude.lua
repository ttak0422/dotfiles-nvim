...
for k, v in pairs({langmenu = "none", shortmess = (vim.o.shortmess .. "sWcS"), cmdheight = 0, termguicolors = true, number = true, signcolumn = "yes", showtabline = 0, laststatus = 0, foldlevel = 99, foldlevelstart = 99, splitkeep = "screen", completeopt = {}, wrap = false}) do
  vim.opt[k] = v
end
