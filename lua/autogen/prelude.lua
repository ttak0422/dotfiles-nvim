...
vim.o.runtimepath = vim.o.runtimepath:gsub(vim.env.VIMRUNTIME, "")
local function _1_()
  return vim.opt.runtimepath:append(vim.env.VIMRUNTIME)
end
vim.api.nvim_create_autocmd("SourcePre", {pattern = "*/plugin/*", once = true, callback = _1_})
...
do
  ...
  local function _5_()
    ...
    local function _6_(id, mod, args)
      local function _7_()
