...
vim.loader.enable()
for k, v in pairs({langmenu = "none", shortmess = (vim.o.shortmess .. "sWcCS"), cmdheight = 0, termguicolors = true, number = true, foldcolumn = "1", signcolumn = "yes", showtabline = 0, laststatus = 0, foldlevel = 99, foldlevelstart = 99, showmode = false}) do
  vim.o[k] = v
end
vim.g.mapleader = " "
