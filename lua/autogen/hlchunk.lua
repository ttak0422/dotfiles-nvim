...
local chunk = {enable = true, chars = {horizontal_line = "\226\148\128", vertical_line = "\226\148\130", left_top = "\226\148\140", left_bottom = "\226\148\148", right_arrow = "\226\148\128"}, style = "#00ffff", delay = 0, use_treesitter = true, exclude_filetypes = {["copilot-chat"] = true}}
