-- [nfnl] Compiled from fnl/window-picker.fnl by https://github.com/Olical/nfnl, do not edit.
local filetype = dofile(args.exclude_ft_path)
local buftype = dofile(args.exclude_buf_ft_path)
...
local filter_rules = {autoselect_one = true, bo = {filetype = filetype, buftype = buftype}, wo = {}, file_path_contains = {}, file_name_contains = {}, include_current_win = false}
