...
is_open = _10_
toggler.register("copilot-chat", {open = open, close = close, is_open = is_open})
local function _12_()
  return toggler.toggle("copilot-chat")
end
return vim.api.nvim_create_user_command("TCopilotChatToggle", _12_, {})
