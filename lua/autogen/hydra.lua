...
Hydra.setup({foreign_keys = nil, color = "red", timeout = 10000, hint = {show_name = true, position = {"bottom"}, offset = 0, float_opts = {}}, on_enter = nil, on_exit = nil, on_key = nil, exit = false, debug = false, invoke_on_body = false})
do
  local heads
  local function _1_()
