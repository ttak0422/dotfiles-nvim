...
return M.setup({use_default_keymaps = true, graph_style = "unicode", console_timeout = 10000, signs = signs, integrations = integrations, disable_context_highlighting = false, disable_hint = false, disable_signs = false, process_spinner = false})
