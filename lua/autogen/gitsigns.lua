...
return signs.setup({signcolumn = true, numhl = true, current_line_blame_formatter = "<author> <author_time:%Y-%m-%d> - <summary>", sign_priority = 6, update_debounce = 1000, max_file_length = 40000, current_line_blame_opts = current_line_blame_opts, preview_config = preview_config, current_line_blame = false})
