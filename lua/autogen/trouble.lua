...
keys = {["?"] = "help", r = "refresh", R = "toggle_refresh", q = "close", o = "jump_close", ["<esc>"] = "cancel", ["<cr>"] = "jump", ["<c-s>"] = "jump_split", ["<c-v>"] = "jump_vsplit", ["}"] = "next", ["]]"] = "next", ["{"] = "prev", ["[["] = "prev", dd = "delete", d = {action = "delete", mode = "v"}, i = "inspect", p = "preview", P = "toggle_preview", zo = "fold_open", zO = "fold_open_recursive", zc = "fold_close", zC = "fold_close_recursive", za = "fold_toggle", zA = "fold_toggle_recursive", zm = "fold_more", zM = "fold_close_all", zr = "fold_reduce", zR = "fold_open_all", zx = "fold_update", zX = "fold_update_all", zn = "fold_disable", zN = "fold_enable", zi = "fold_toggle_enable", gb = {action = _1_, desc = "Toggle Current Buffer Filter"}, s = {action = _2_, desc = "Toggle Severity Filter"}}
...
return M.setup({auto_refresh = true, follow = true, indent_guides = true, max_items = 200, multiline = true, open_no_results = true, win = win, preview = preview, keys = keys, modes = modes, icons = icons, focus = false, auto_close = false, auto_jump = false, warn_no_results = false, auto_preview = false, debug = false, pinned = false, auto_open = false})
