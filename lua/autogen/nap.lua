-- [nfnl] Compiled from fnl/nap.fnl by https://github.com/Olical/nfnl, do not edit.
local M = require("nap")
...
safe_qf_cnewer = _6_
local exclude_default_operators = {"f", "F", "z", "s", "'", "l", "L", "<C-l>", "<M-l>"}
local operators
local function _8_()
