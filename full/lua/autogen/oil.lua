-- [nfnl] Compiled from full/fnl/oil.fnl by https://github.com/Olical/nfnl, do not edit.
do
  local M = require("oil")
  local columns = {"icon"}
  local border = "none"
